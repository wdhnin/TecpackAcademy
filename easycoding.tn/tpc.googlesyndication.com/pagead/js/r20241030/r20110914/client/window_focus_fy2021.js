(function() {
    ...
    */
    function g(a, b, e) {
        if (Array.isArray(b))
            for (let c = 0; c < b.length; c++) g(a, String(b[c]), e);
        ...
        if (e || c) {
            const k = h => {
                ...
                if (c) {
                    ...
                    v >= 0 && Array.prototype.splice.call(h, v, 1)
                }
    ...
    function w(a, b, e = 0) {
        ...
        if (!(Math.random() > .01)) {
            a = (a = p(document.currentScript)) && a.getAttribute("data-jc-rcd") === "true" ? "pagead2.googlesyndication-cn.com" : "pagead2.googlesyndication.com";
            c = (c = p(document.currentScript)) && c.getAttribute("data-jc-version") || "unknown";
            ...
            d && c.navigator.sendBeacon ? c.navigator.sendBeacon(a) : m(c, a, void 0, !1)
        }
    }
    var z = class {
        constructor() {
